 ...
 */
class StemteachersCustomSubmittedForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'stemteachers_custom_submitted_form';
  }
  ...
  protected function getEditableConfigNames() {
    return ['stemteachers_custom.stemteachers_custom_submitted'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $sub = $this->config('stemteachers_custom.stemteachers_custom_submitted');
    try {
    ...
    foreach ($content_types as $type => $info) {
      $form['stemteachers_custom_submitted'][$type] = [
        '#type' => 'textarea',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $config = $this->config('stemteachers_custom.stemteachers_custom_submitted');
    foreach ($form_state->getValue('stemteachers_custom_submitted') as $key => $value) {
