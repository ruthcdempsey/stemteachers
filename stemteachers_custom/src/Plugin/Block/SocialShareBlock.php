...
class SocialShareBlock extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   */
  private function buildSocialLink(string $share_link, string $share_channel, array $query, array $icon_classes) {
    ...
    return [
      ...
      '#title' => [
        '#markup' => $this->svgIcon($icon_classes),
      ],
    ];
  }
   ...
   */
  public function svgIcon(array $icon_classes) {
    return Markup::create('<i class="' . implode(' ', $icon_classes) . '"></i>');
  }
